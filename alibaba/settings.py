...
# 图片下载路径
IMAGES_STORE = "/Users/xiaobaoxia/Desktop/alibabaimage/"
...
DEFAULT_REQUEST_HEADERS = {
   # ':authority':'dcms.1688.com',
   # ':method':'GET',
   # ':path':'/open/query.json?resourceId=405457&dataId=236',
   # ':scheme':'https',
   # 'accept':'*/*',
   # 'accept-encoding':'gzip, deflate, br',
   # 'accept-language':'zh-CN,zh;q=0.9',
   # 'referer':'https://dcms.1688.com/open/query.json?resourceId=405457&dataId=236',
...
ITEM_PIPELINES = {
   ...
   'alibaba.pipelines.AliImagePipeline': 200,
}
